const defaultConfig = {
    ...
    upgrades: {
        ...
        branch_count: { id: 'branch_count', category: 'branch', name: '機器採購', desc: '增加機器人數量，每級 +1 台機器人', level: 0, maxLevel: 6, baseCost: 1000, costResource: 'branch', multiplier: 3.2 },
        ...
        unlock_map2: { id: 'unlock_map2', category: 'wood', name: '解鎖【地圖】', desc: '可切換至其他地區，並解鎖寒帶針葉林', level: 0, maxLevel: 1, baseCost: 30000, costResource: 'wood', multiplier: 1.0, onPurchase: () => { gameState.unlockedMap2 = true; initUI(); } },
        ...
        unlock_prestige: { id: 'unlock_prestige', category: 'pine_wood', name: '解鎖【初級轉生】', desc: '解鎖初級轉生系統', level: 0, maxLevel: 1, baseCost: 50000, costResource: 'pine_wood', multiplier: 1.0, onPurchase: () => { gameState.unlockedPrestige = true; gameState.resources.prestige_coin.unlocked = true; initUI(); } },
        unlock_broad_robot: { id: 'unlock_broad_robot', category: 'pine_wood', name: '掃闊葉機器人採購', desc: '解鎖闊葉', level: 0, maxLevel: 1, baseCost: 30000, costResource: 'pine_wood', multiplier: 1.0, onPurchase: () => { gameState.resources.broad_leaf.unlocked = true; gameState.robots.broadSweeper.unlocked = true; gameState.robots.broadSweeper.baseCount = 1; initUI(); } },
        broad_leaf_amount: { id: 'broad_leaf_amount', category: 'broad_leaf', name: '清掃量升級', desc: '每級 +1 片闊葉', level: 0, maxLevel: 500, baseCost: 10, costResource: 'broad_leaf', multiplier: 1.25 },
        broad_leaf_speed: { id: 'broad_leaf_speed', category: 'broad_leaf', name: '清掃效率升級', desc: '-0.01 秒冷卻', level: 0, maxLevel: 150, baseCost: 10, costResource: 'broad_leaf', multiplier: 1.18 },
        broad_leaf_count: { id: 'broad_leaf_count', category: 'broad_leaf', name: '機器採購', level: 0, maxLevel: 7, baseCost: 2000, costResource: 'broad_leaf', multiplier: 3.3 },
        unlock_broad_branch_robot: { id: 'unlock_broad_branch_robot', category: 'broad_leaf', name: '撿闊枝機器人', level: 0, maxLevel: 1, baseCost: 20000, costResource: 'broad_leaf', onPurchase: () => { gameState.resources.broad_branch.unlocked = true; gameState.robots.broadBranchCollector.unlocked = true; gameState.robots.broadBranchCollector.baseCount = 1; initUI(); } },
        broad_branch_amount: { id: 'broad_branch_amount', category: 'broad_branch', name: '清掃量升級', level: 0, maxLevel: 500, baseCost: 15, costResource: 'broad_branch', multiplier: 1.25 },
        broad_branch_speed: { id: 'broad_branch_speed', category: 'broad_branch', name: '清掃效率升級', level: 0, maxLevel: 200, baseCost: 15, costResource: 'broad_branch', multiplier: 1.18 },
        broad_branch_count: { id: 'broad_branch_count', category: 'broad_branch', name: '機器採購', level: 0, maxLevel: 6, baseCost: 2000, costResource: 'broad_branch', multiplier: 3.3 },
        unlock_broad_wood_robot: { id: 'unlock_broad_wood_robot', category: 'broad_branch', name: '伐闊木機器人', level: 0, maxLevel: 1, baseCost: 30000, costResource: 'broad_branch', onPurchase: () => { gameState.resources.broad_wood.unlocked = true; gameState.robots.broadLumberjack.unlocked = true; gameState.robots.broadLumberjack.baseCount = 1; initUI(); } },
        broad_wood_amount: { id: 'broad_wood_amount', category: 'broad_wood', name: '清掃量升級', level: 0, maxLevel: 500, baseCost: 20, costResource: 'broad_wood', multiplier: 1.25 },
        broad_wood_speed: { id: 'broad_wood_speed', category: 'broad_wood', name: '清掃效率升級', level: 0, maxLevel: 250, baseCost: 20, costResource: 'broad_wood', multiplier: 1.18 },
        broad_wood_count: { id: 'broad_wood_count', category: 'broad_wood', name: '機器採購', level: 0, maxLevel: 5, baseCost: 2000, costResource: 'broad_wood', multiplier: 3.3 },
        unlock_sakura_robot: { id: 'unlock_sakura_robot', category: 'broad_wood', name: '掃櫻花機器人', level: 0, maxLevel: 1, baseCost: 40000, costResource: 'broad_wood', onPurchase: () => { gameState.resources.sakura_leaf.unlocked = true; gameState.robots.sakuraSweeper.unlocked = true; gameState.robots.sakuraSweeper.baseCount = 1; initUI(); } },
        sakura_leaf_amount: { id: 'sakura_leaf_amount', category: 'sakura_leaf', name: '清掃量升級', level: 0, maxLevel: 500, baseCost: 10, costResource: 'sakura_leaf', multiplier: 1.25 },
        sakura_leaf_speed: { id: 'sakura_leaf_speed', category: 'sakura_leaf', name: '清掃效率升級', level: 0, maxLevel: 150, baseCost: 10, costResource: 'sakura_leaf', multiplier: 1.18 },
        sakura_leaf_count: { id: 'sakura_leaf_count', category: 'sakura_leaf', name: '機器採購', level: 0, maxLevel: 7, baseCost: 2000, costResource: 'sakura_leaf', multiplier: 3.3 },
        unlock_sakura_branch_robot: { id: 'unlock_sakura_branch_robot', category: 'sakura_leaf', name: '撿櫻枝機器人', level: 0, maxLevel: 1, baseCost: 30000, costResource: 'sakura_leaf', onPurchase: () => { gameState.resources.sakura_branch.unlocked = true; gameState.robots.sakuraBranchCollector.unlocked = true; gameState.robots.sakuraBranchCollector.baseCount = 1; initUI(); } },
        sakura_branch_amount: { id: 'sakura_branch_amount', category: 'sakura_branch', name: '清掃量升級', level: 0, maxLevel: 500, baseCost: 15, costResource: 'sakura_branch', multiplier: 1.25 },
        sakura_branch_speed: { id: 'sakura_branch_speed', category: 'sakura_branch', name: '清掃效率升級', level: 0, maxLevel: 200, baseCost: 15, costResource: 'sakura_branch', multiplier: 1.18 },
        sakura_branch_count: { id: 'sakura_branch_count', category: 'sakura_branch', name: '機器採購', level: 0, maxLevel: 6, baseCost: 2000, costResource: 'sakura_branch', multiplier: 3.3 },
        unlock_sakura_wood_robot: { id: 'unlock_sakura_wood_robot', category: 'sakura_branch', name: '伐櫻木機器人', level: 0, maxLevel: 1, baseCost: 45000, costResource: 'sakura_branch', onPurchase: () => { gameState.resources.sakura_wood.unlocked = true; gameState.robots.sakuraLumberjack.unlocked = true; gameState.robots.sakuraLumberjack.baseCount = 1; initUI(); } },
        sakura_wood_amount: { id: 'sakura_wood_amount', category: 'sakura_wood', name: '清掃量升級', level: 0, maxLevel: 500, baseCost: 20, costResource: 'sakura_wood', multiplier: 1.25 },
        sakura_wood_speed: { id: 'sakura_wood_speed', category: 'sakura_wood', name: '清掃效率升級', level: 0, maxLevel: 250, baseCost: 20, costResource: 'sakura_wood', multiplier: 1.18 },
        sakura_wood_count: { id: 'sakura_wood_count', category: 'sakura_wood', name: '機器採購', level: 0, maxLevel: 5, baseCost: 2000, costResource: 'sakura_wood', multiplier: 3.3 },
        recycle_amount: { id: 'recycle_amount', category: 'recycle', name: '幣值提升', level: 1, maxLevel: 20, baseCost: 834, costResource: 'recycle_coin', multiplier: 1.2 },
        recycle_speed: { id: 'recycle_speed', category: 'recycle', name: '回收效率', level: 0, maxLevel: 250, baseCost: 500, costResource: 'recycle_coin', multiplier: 1.15 },
        recycle_efficiency: { id: 'recycle_efficiency', category: 'recycle', name: '成本降低', level: 0, maxLevel: 50, baseCost: 750, costResource: 'recycle_coin', multiplier: 1.175 },
        recycle_factory: { id: 'recycle_factory', category: 'recycle', name: '新建廠房', level: 0, maxLevel: 10, baseCost: 2000, costResource: 'recycle_coin', multiplier: 1.25 },
        pres_leaf_boost: { id: 'pres_leaf_boost', category: 'prestige', name: '落葉 升級', level: 1, maxLevel: 20, baseCost: 0.5, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_branch_boost: { id: 'pres_branch_boost', category: 'prestige', name: '樹枝 升級', level: 1, maxLevel: 20, baseCost: 1, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_wood_boost: { id: 'pres_wood_boost', category: 'prestige', name: '木頭 升級', level: 1, maxLevel: 20, baseCost: 2, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_pine_leaf_boost: { id: 'pres_pine_leaf_boost', category: 'prestige', name: '松葉 升級', level: 1, maxLevel: 20, baseCost: 2, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_pine_branch_boost: { id: 'pres_pine_branch_boost', category: 'prestige', name: '松枝 升級', level: 1, maxLevel: 20, baseCost: 4, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_pine_wood_boost: { id: 'pres_pine_wood_boost', category: 'prestige', name: '松木 升級', level: 1, maxLevel: 20, baseCost: 8, costResource: 'prestige_coin', multiplier: 2.0 },
		pres_broad_leaf_boost: { id: 'pres_broad_leaf_boost', category: 'prestige', name: '闊葉 升級', level: 1, maxLevel: 20, baseCost: 8, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_broad_branch_boost: { id: 'pres_broad_branch_boost', category: 'prestige', name: '闊枝 升級', level: 1, maxLevel: 20, baseCost: 16, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_broad_wood_boost: { id: 'pres_broad_wood_boost', category: 'prestige', name: '闊木 升級', level: 1, maxLevel: 20, baseCost: 32, costResource: 'prestige_coin', multiplier: 2.0 },
		pres_sakura_leaf_boost: { id: 'pres_sakura_leaf_boost', category: 'prestige', name: '櫻花 升級', level: 1, maxLevel: 20, baseCost: 32, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_sakura_branch_boost: { id: 'pres_sakura_branch_boost', category: 'prestige', name: '櫻枝 升級', level: 1, maxLevel: 20, baseCost: 64, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_sakura_wood_boost: { id: 'pres_sakura_wood_boost', category: 'prestige', name: '櫻木 升級', level: 1, maxLevel: 20, baseCost: 128, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_recycle_boost: { id: 'pres_recycle_boost', category: 'prestige', name: '回收廠 效率', level: 1, maxLevel: 20, baseCost: 1, costResource: 'prestige_coin', multiplier: 2.0 },
        pres_recycle_efficiency: { id: 'pres_recycle_efficiency', category: 'prestige', name: '回收廠 成本降低', level: 0, maxLevel: 30, baseCost: 10, costResource: 'prestige_coin', multiplier: 1.2 },
		pres_coin_boost: { id: 'pres_coin_boost', category: 'prestige', name: '初級硬幣量提升', level: 0, maxLevel: 100, baseCost: 10, costResource: 'prestige_coin', multiplier: 1.8 },
        unlock_map3: { id: 'unlock_map3', category: 'prestige', name: '解鎖 闊木林', level: 0, maxLevel: 1, baseCost: 200, costResource: 'prestige_coin', onPurchase: () => { gameState.unlockedMap3 = true; initUI(); } },
		unlock_map4: { id: 'unlock_map4', category: 'prestige', name: '解鎖 櫻花林', level: 0, maxLevel: 1, baseCost: 1000, costResource: 'prestige_coin', onPurchase: () => { gameState.unlockedMap4 = true; initUI(); } }
	},

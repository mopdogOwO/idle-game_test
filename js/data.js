const defaultConfig = {
	...
	upgrades: {
        ...
        unlock_broad_branch_robot: { id: 'unlock_broad_branch_robot', category: 'broad_leaf', name: '撿闊枝機器人採購', desc: '解鎖闊枝與撿闊枝機器人', level: 0, maxLevel: 1, baseCost: 20000, costResource: 'broad_leaf', onPurchase: () => { gameState.resources.broad_branch.unlocked = true; gameState.robots.broadBranchCollector.unlocked = true; gameState.robots.broadBranchCollector.baseCount = 1; initUI(); } },
        ...
        recycle_speed: { id: 'recycle_speed', category: 'recycle', name: '回收效率', desc: '回收速度增加，每級 -0.02 秒轉換所需時間', level: 0, maxLevel: 250, baseCost: 500, costResource: 'recycle_coin', multiplier: 1.15 },
        ...
        pres_recycle_boost: { id: 'pres_recycle_boost', category: 'prestige', name: '回收廠 素材轉換效率', desc: '提升 回收廠 素材轉換的數量，每級為基礎量的100%', level: 1, maxLevel: 20, baseCost: 1, costResource: 'prestige_coin', multiplier: 2.0 },
        ...
        pres_coin_boost: { id: 'pres_coin_boost', category: 'prestige', name: '初級硬幣量提升', desc: '提升獲得的初級硬幣量，每級+1%', level: 0, maxLevel: 100, baseCost: 3, costResource: 'prestige_coin', multiplier: 1.8 },
        unlock_map3: { id: 'unlock_map3', category: 'prestige', name: '解鎖 闊木林', desc: '解鎖後可切換至闊木林地區', level: 0, maxLevel: 1, baseCost: 200, costResource: 'prestige_coin', onPurchase: () => { gameState.unlockedMap3 = true; initUI(); } },
        unlock_map4: { id: 'unlock_map4', category: 'prestige', name: '解鎖 櫻花林', desc: '解鎖後可切換至櫻花林地區', level: 0, maxLevel: 1, baseCost: 1000, costResource: 'prestige_coin', onPurchase: () => { gameState.unlockedMap4 = true; initUI(); } }
    },
